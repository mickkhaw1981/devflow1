...
// Import required dependencies from Radix UI, Lucide icons, and React
...
// Basic dropdown menu components with default Radix UI functionality
...
// SubTrigger component - Used for nested dropdown menus
// Renders a button that opens a sub-menu when clicked
...
// SubContent component - Contains the content of a sub-menu
...
// Checkbox item component - For selectable menu items with checkboxes
...
// Radio item component - For mutually exclusive selectable items
...
// Label component - For section headers within the menu
...
// Separator component - Renders a horizontal line between menu items
